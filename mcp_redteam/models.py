...
RULE_REGISTRY: dict[str, Rule] = {
    ...
    "MRT007": Rule(id="MRT007", name="Missing Error Handling", description="MCP tool function lacks try/except", severity=Severity.MEDIUM, category=FindingCategory.health),
    ...
    "MRT026": Rule(id="MRT026", name="JS Missing Error Handling", description="MCP tool handler registered via server.tool()/setRequestHandler() without try/catch", severity=Severity.MEDIUM, category=FindingCategory.health),
