...
RULE_REGISTRY: dict[str, Rule] = {
    ...
    "MRT006": Rule(id="MRT006", name="Stdout Pollution", description="print()/console.log() pollutes JSON-RPC stdio stream", severity=Severity.MEDIUM, category=FindingCategory.health),
