...
| 253 tests | Passing | Unit, security, stress, edge cases, packaging, Hypothesis fuzzing |
...
| Self-tested | Unknown | Unknown | **253 tests, self-security audit** |
...
253 tests across 15 test files:
