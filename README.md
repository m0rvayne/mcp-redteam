...
| 245 tests | Passing | Unit, security, stress, edge cases, packaging, Hypothesis fuzzing |
...
| Self-tested | Unknown | Unknown | **245 tests, self-security audit** |
...
245 tests across 15 test files:
